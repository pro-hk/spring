...
<body>
	...
	<form class="form" action="InsertProcess.do" enctype="multipart/form-data" method="post" enctype="multipart/form-data">
			<table>
				<colgroup>
					<col style="width:20%">
					<col>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<!-- <input type="file" name="multipartFile" placeholder="업로드할 이미지를 선택하세요"> -->
						</td>
					</tr>
					<tr>
						<th>점수</th>
						<td>
							<input type="text" name="point" placeholder="점수를 입력하세요">
						</td>
					</tr>
				</tbody>
			</table>
			<div class="btns">
				<button class="btn btnConfirm" type="submit">확인</button>
				<button class="btn btnCancel" type="reset">취소</button>
			</div>
		</form>
</body>
</html>