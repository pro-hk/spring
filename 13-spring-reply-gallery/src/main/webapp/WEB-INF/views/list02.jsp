...
<body>
	...
	<div id="detail">
		<div class="container">
			<div class="imgBox">
				<img src="/13-spring-reply-gallery/galleryImage/8cb26a55-cf8b-443c-b9f6-ef4e90607ef5.png" />
			</div>
			<div class="replyBox">
				<div class="inner">
					<textarea name="reply" id="reply" placeholder="댓글을 입력하세요"></textarea>
		...
		<div class="btns">
			<button class="btnDelete">글삭제</button>
			<button class="btnReplyDelete">댓글전체삭제</button>
