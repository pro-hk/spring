...
<%@ include file="../include/header.jsp" %>
    <main>
      <div class="inner">
      	...
      	<div id=contents>
      		<form method="post" action="../board/WriteProcess.do" id="join" class="form">
      			<table class="left">
      				<colgroup>
      					<col style="width:20%">
      					<col style="width:80%">
      				...
      				<tbody>
      					<tr>
      						...
      						<td>
      						<input type="text" name="name" id="user_name" placeholder="이름을 입력하세요." value="${loggedMember.name }" >
      						</td>
      					</tr>
      					<tr>
      						<th>제목 <span class="required">*</span></th>
      						<td>
      						<input type="text" name="subject" id="user_subject" placeholder="제목을 입력하세요." >
      						</td>
      					</tr>
      					<tr>
      						<th>이메일 <span class="required">*</span></th>
      						<td><input type="text" name="email" id="user_email" placeholder="메일을 입력하세요." value="${loggedMember.email }"></td>
      					</tr>
      					<tr>
