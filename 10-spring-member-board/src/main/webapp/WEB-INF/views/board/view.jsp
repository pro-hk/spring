      	...
      	<div id=contents>
      		<div class="form">
      			...
      			<div class="btns">
      				...
      				<a href="../board/Reply.do?no=${replyBoardDto.no }&reGroup=${replyBoardDto.reGroup }&reStep=${replyBoardDto.reStep }&reLevel=${replyBoardDto.reLevel }"  class="btn btnConfirm">답글쓰기</a>
