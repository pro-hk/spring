...
<%@ include file="../include/header.jsp" %>
    <main>
      <div class="inner">
      	...
      	<div id=contents>
      		<form method="post" action="ReplyProcess.do" id="join" class="form">
      			<table>
      				<colgroup>
      					<col style="width:20%">
      					<col style="width:80%">
      				...
      				<tbody>
      					<tr>
      						...
      						<td>
      						<input type="text" name="name" id="user_name" value="${loggedMember.name}" placeholder="이름을 입력하세요." >
      						</td>
      					</tr>
      					<tr>
      					...
      					<tr>
      						...
      						<td><input type="text" name="email" id="user_email" value="${loggedMember.email}" placeholder="메일을 입력하세요."></td>
      					</tr>
      					<tr>
