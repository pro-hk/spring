      			...
      			<table class="left">
      				...
      				<tbody>
      					<tr>
      						...
      						<td>
      						<input type="text" name="name" id="user_name" placeholder="이름을 입력하세요." value="${boardDto.name }">
      						</td>
      					</tr>
      					<tr>
      						<th>제목 <span class="required">*</span></th>
      						<td>
      						<input type="text" name="subject" id="user_subject" placeholder="제목을 입력하세요." value="${boardDto.subject }">
      						</td>
      					</tr>
      					<tr>
      						<th>이메일 <span class="required">*</span></th>
      						<td><input type="text" name="email" id="user_email" placeholder="메일을 입력하세요." value="${boardDto.email }"></td>
      					</tr>
      					<tr>
      					...
      					<tr>
      						...
      						<td><textarea placeholder="내용을 입력하세요" name="contents" id="summernote">${boardDto.contents }</textarea></td>
      					</tr>
      				</tbody>
      			</table>
      			<div class="btns">
