...
<%@ include file="../include/header.jsp" %>
    <main>
      <div class="inner">
      	...
      	<div id=contents>
      		<form method="post" action="../member/UpdateProcess.do" id="join" class="form" enctype="multipart/form-data">
      			<table class="left">
      				<colgroup>
      					<col style="width:20%">
      					<col style="width:80%">
      				...
      				<tbody>
      					<tr>
      						<th>PROFILE <span class="required">*</span></th>
      						<td>
      							<div>
      								<img src=${memberDto.thumb } class="profile02" />
      							</div>
      							<div class="fileBox">
      								<input type="text" class="fakeFile" placeholder="업로드할 이미지를 선택하세요">
      					...
      					<tr>
      						...
      						<td><input type="text" name="name" id="user_name" value="${memberDto.name }"></td>
      					</tr>
      					<tr>
      						<th>이메일 <span class="required">*</span></th>
      						<td><input type="text" name="email" id="user_email" placeholder="메일을 입력하세요." value="${memberDto.email }"></td>
      					</tr>
      					<tr>
      						...
      						<td class="left">
      							...
      							<input type="text" name="phoneMiddle" class="short" id="user_phone_middle" placeholder="전화번호를 입력하세요." value="${memberDto.phoneMiddle }">
      							<input type="text" name="phoneLast" class="short" id="user_phone_last" placeholder="전화번호를 입력하세요." value="${memberDto.phoneLast }">
      						</td>
      					</tr>
      					<tr>
      			...
      			<div class="btns">
      				...
      				<button type="reset" class="btn btnCancel">초기화</button>
